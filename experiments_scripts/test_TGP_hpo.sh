#!/bin/bash
#SBATCH --job-name=scenario_srbench_TGP_hpo
#SBATCH --output=scenario_srbench_TGP_hpo_%a.txt
...
python3 -m examples.symbolic_regression.scenario_srbench --algo TGP -o -s $seed -d $dataset
