...
ge_hyperparameters_baseline = GEHyperparameters(
    pop_size=256,
    mutation_rate=0.1,
    cx_rate=0.9,
    tournament_size=2,
...
ge_hyperparameters_optimized = GEHyperparameters(
    pop_size=500,
    mutation_rate=0.1,
    cx_rate=0.523,
    tournament_size=9,
...
for dataset in datasets:
    ...
    for run_idx, seed in enumerate(seeds, start=1):
        ...
        ge_config.global_seed = seed

        # Baseline model
        model_base = SRBench("GE", ge_config, ge_hyperparameters_baseline,
        ...
        # Optimized model
        model_opt = SRBench("GE", ge_config, ge_hyperparameters_optimized,
                            functions=functions, grammar=grammar)
...
# #SBATCH --job-name=srbench_3ge
# #SBATCH --array=1-10
# #SBATCH --output=srbench_3ge_656_fri_%a.txt
# #SBATCH --account=thes2090
...
# python -m src.hpo.srbench_ge_${SLURM_ARRAY_TASK_ID}