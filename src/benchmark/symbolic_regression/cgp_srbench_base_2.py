...
cgp_hyperparams = CGPHyperparameters(
    mu=1,
    lmbda=99,
    population_size=50, # Dr. Kalkreuth's findings for DR
    ...
    cx_rate = 0.7, # crossover rate of 0.5 or 0.7 for DR
    tournament_size = 7, # because of the larger pop size
    num_function_nodes = 200 # larger genotype to allow for neutral genetic drift according to dogma
)
