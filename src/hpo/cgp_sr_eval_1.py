...
print(f"PERFORMANCE OF CONFIGURATION NO. {run}")
print("="*50)
...
best_fitness_min = np.min(results_test["fitness"])
best_fitness_max = np.max(results_test["fitness"])

print(f"Mean best fitness (train_set): {mean_best_fitness}")
print(f"Variance of best fitness (train_set): {best_fitness_var}")
print(f"Standard deviation of best fitness (train_set): {best_fitness_std}")
print(f"Quartiles of best fitness (train_set): {best_fitness_quart}")
print(f"Minimum best fitness (train_set): {best_fitness_min}")
print(f"Maximum best fitness (train_set): {best_fitness_max}")
print("="*50)
...
fitness_min = np.min(results_test["fitness"])
fitness_max = np.max(results_test["fitness"])

print(f"Mean fitness (test set): {mean_fitness}")
print(f"Variance of fitness (test set): {fitness_var}")
print(f"Standard deviation of fitness (test set): {fitness_std}")
print(f"Quartiles of fitness (old config, test set): {fitness_quart}")
print(f"Minimum fitness (test_set): {fitness_min}")
print(f"Maximum fitness (test_set): {fitness_max}")
print("="*50)
...
r2_score_min = np.min(results_test["r2_score"])
r2_score_max = np.max(results_test["r2_score"])

print(f"Mean R2 score (train set): {mean_r2_score}")
print(f"Variance of R2 score (train set): {r2_score_var}")
print(f"Standard deviation of R2 score (train set): {r2_score_std}")
print(f"Quartiles of R2 score (train set): {r2_score_quart}")
print(f"Minimum R2 score (train set): {r2_score_min}")
print(f"Maximum R2 score (train set): {r2_score_max}")
print("="*50)
...
print(f"Mean R2 score (test set): {mean_r2_score_test}")
print(f"Variance of R2 score (test set): {r2_score_var_test}")
print(f"Standard deviation of R2 score (test set): {r2_score_std_test}")
print(f"Quartiles of R2 score (test set): {r2_score_quart_test}")
print(f"Minimum R2 score (test set): {r2_score_min}")
print(f"Maximum R2 score (test set): {r2_score_max}")
print("="*50)

print(f"This is optimised config {run}")
